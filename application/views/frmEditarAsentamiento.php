...
<div class="panel panel-default col-lg-10 col-lg-offset-1" ng-controller="asentamientoEditCtrl">
    <div class="panel-heading"><h4>Tipo De Asentamientos</h4></div>
    <ol class="breadcrumb">
        <li><a href="<?php echo base_url('asentamientos/index'); ?>">Tipo De Asentamientos</a></li>
