...
<div class="panel panel-default col-lg-10 col-lg-offset-1" ng-controller="tipologiasCtrl">
    <div class="panel-heading"><h4>Tipologías</h4></div>
    <div class="row" style="margin-top: 11px;">
        <form method="GET" style="margin-top: 13px;" action="<?php echo base_url('tipologias/index'); ?>">           
        ...
        <a href="<?php echo base_url('tipologias/agregar'); ?>"><button type="button" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Nuevo</button></a>               
    </div>
                ...
                if ($resultado != 0) {
                    foreach ($resultado as $key => $results) {
                        ...
                        if (intval($results->estatus) == 1)
                            ...
                            echo '<td>INACTIVO</td>';
                        echo '<td><a href="' . base_url('tipologias/editar/?id=' . $results->id_tipologia) . '"><button type="button" title="Editar" class="btn btn-primary glyphicon glyphicon-pencil"></button></a></td>';
                        echo '</tr>';
                    }
                }
                ?>
