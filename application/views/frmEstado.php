...
<div class="panel panel-default col-lg-10 col-lg-offset-1" ng-controller="estadoAgregarCtrl">
    ...
    <form role="form" class="form-horizontal" name="frmEstado" id="frmEstado" novalidate="">
        <div class="form-group has-feedback"  ng-class="cssInput(frmEstado.descripcion)">
            ...
            <div ng-show="frmEstado.$submitted || frmEstado.descripcion.$touched">
                <p ng-show="frmEstado.descripcion.$error.required" class="help-block errorRequerido">El nombre del estado es requirido.</p>
            </div>
        ...
        <div class="form-group has-feedback" ng-class="cssInput(frmEstado.id_pais)">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" ng-change="" required id="id_pais" name="id_pais" ng-model="datos.id_pais">
                ...
                <div ng-show="frmEstado.$submitted || frmColonia.id_pais.$touched">
                    <p ng-show="frmEstado.id_pais.$error.required" class="help-block errorRequerido">El país es requirido.</p>
                </div>
            </div>
        </div>
