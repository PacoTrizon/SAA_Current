...
<div class="panel panel-default col-lg-10 col-lg-offset-1" ng-controller="solicitantesCtrl">
    <div class="panel-heading"><h4>Solicitantes</h4></div>
    <div class="row" style="margin-top: 11px;">
        <form method="GET" style="margin-top: 13px;" action="<?php echo base_url('solicitantes/index'); ?>">           
        ...
        <a href="<?php echo base_url('solicitantes/agregar'); ?>"><button type="button" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Nuevo</button></a>
            ...
            <tbody>
                ...
                if ($resultado != 0) {
                    foreach ($resultado as $key => $results) {
                        ...
                        echo '<td>' . $results->nombre_dependencia . '</td>';
                        if (intval($results->estatus) == 1)
                            echo '<td>ACTIVO</td>';
                        else
                            echo '<td>INACTIVO</td>';
                        echo '<td><a href="' . base_url('solicitantes/editar/?id=' . $results->solicitante_id) . '"><button type="button" title="Editar" class="btn btn-primary glyphicon glyphicon-pencil"></button></a></td>';
                        echo '</tr>';
                    }
                }
                ?>
