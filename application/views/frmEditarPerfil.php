...
<div class="panel panel-default col-lg-10 col-lg-offset-1" ng-controller="perfilEditarCtrl">
    <div class="panel-heading"><h4>Perfiles</h4></div>
    <ol class="breadcrumb">
        <li><a href="<?php echo base_url('perfiles/index'); ?>">Perfiles</a></li>
        <li class="active">Editar</li>
    </ol>
    <form role="form" class="form-horizontal" name="frmEditarPerfil" id="frmEditarPerfil" novalidate="">
        <div class="form-inline">
            <div class="form-group has-feedback col-sm-4"  ng-class="cssInput(frmEditarPerfil.descripcion)">
                ...
                <div class="col-sm-8">
                    ...
                    <span class="glyphicon form-control-feedback" ng-class="cssIcono(frmEditarPerfil.descripcion)"></span>
                    <div ng-show="frmEditarPerfil.$submitted || frmEditarPerfil.descripcion.$touched">
                        <p ng-show="frmEditarPerfil.descripcion.$error.required" class="help-block errorRequerido">El nombre del perfil es requirido.</p>                        
                    </div>
                    <p ng-show="frmEditarPerfil.descripcion.$error.minlength" class="help-block errorRequerido">El mínimo es de 3</p>
                    <p ng-show="frmEditarPerfil.descripcion.$error.maxlength" class="help-block errorRequerido">El máximo es de 100</p>
                </div>   

                <label for="descripcion" style="margin-top: 9px;" class="control-label col-lg-3">Estatus:</label>
                <div class="col-sm-9" style="margin-top: 9px;">
                    <div class="btn-group">
                        <button type="button" id="activo" name="activo" ng-click="claseEstatus('activo')" class="btn btn-success boton_estatus_perfil">ACTIVO</button>
                        <button type="button" id="inactivo" name="inactivo" ng-click="claseEstatus('inactivo')" class="btn btn-default boton_estatus_perfil">INACTIVO</button>
                    </div>
                </div>
            </div>
                        ...
                        <table class="table">
                            ...
                            <tbody id="encabezados" class="collapse">
                                <tr ng-repeat="permiso in list_permisos">
                                    ...
                                    <td ng-if="permiso.tipo == 'encabezado'" class="ancho_listado_checkbox"><input type="checkbox" ng-click="agregar_permiso(permiso, $index)" ng-model="check(permiso)" class="size_checkBox"></td> 
                                </tr>
                            </tbody>
                        </table>
                        <table class="table">
                            ...
                            <tbody id="usuarios" class="collapse">
                                <tr ng-repeat="permiso in list_permisos">
                                    ...
                                    <td ng-if="permiso.grupo == 'usuarios'" class="ancho_listado_checkbox"><input type="checkbox" ng-click="agregar_permiso(permiso, $index)" ng-model="check(permiso)" class="size_checkBox"></td> 
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <table class="table">
                            ...
                            <tbody id="perfiles" class="collapse">
                                <tr ng-repeat="permiso in list_permisos">
                                    ...
                                    <td ng-if="permiso.grupo == 'perfiles'" class="ancho_listado_checkbox"><input type="checkbox" ng-click="agregar_permiso(permiso, $index)" ng-model="check(permiso)" class="size_checkBox"></td> 
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <table class="table">
                            ...
                            <tbody id="colonia" class="collapse">
                                <tr ng-repeat="permiso in list_permisos">
                                    ...
                                    <td ng-if="permiso.grupo == 'colonia'" class="ancho_listado_checkbox"><input type="checkbox" ng-click="agregar_permiso(permiso, $index)" ng-model="check(permiso)" class="size_checkBox"></td> 
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <table class="table">
                            ...
                            <tbody id="dependencia" class="collapse">
                                <tr ng-repeat="permiso in list_permisos">
                                    ...
                                    <td ng-if="permiso.grupo == 'dependencia'" class="ancho_listado_checkbox"><input type="checkbox" ng-click="agregar_permiso(permiso, $index)" ng-model="check(permiso)" class="size_checkBox"></td> 
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <table class="table">
                            ...
                            <tbody id="estado" class="collapse">
                                <tr ng-repeat="permiso in list_permisos">
                                    ...
                                    <td ng-if="permiso.grupo == 'estado'" class="ancho_listado_checkbox"><input type="checkbox" ng-click="agregar_permiso(permiso, $index)" ng-model="check(permiso)" class="size_checkBox"></td> 
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <table class="table">
                            ...
                            <tbody id="municipio" class="collapse">
                                <tr ng-repeat="permiso in list_permisos">
                                    ...
                                    <td ng-if="permiso.grupo == 'municipio'" class="ancho_listado_checkbox"><input type="checkbox" ng-click="agregar_permiso(permiso, $index)" ng-model="check(permiso)" class="size_checkBox"></td> 
                                </tr>
                            </tbody>
                        </table> 
                        <table class="table">
                            ...
                            <tbody id="pais" class="collapse">
                                <tr ng-repeat="permiso in list_permisos">
                                    ...
                                    <td ng-if="permiso.grupo == 'pais'" class="ancho_listado_checkbox"><input type="checkbox" ng-click="agregar_permiso(permiso, $index)" ng-model="check(permiso)" class="size_checkBox"></td> 
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <table class="table">
                            ...
                            <tbody id="sindicatura" class="collapse">
                                <tr ng-repeat="permiso in list_permisos">
                                    ...
                                    <td ng-if="permiso.grupo == 'sindicatura'" class="ancho_listado_checkbox"><input type="checkbox" ng-click="agregar_permiso(permiso, $index)" ng-model="check(permiso)" class="size_checkBox"></td> 
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <table class="table">
                            ...
                            <tbody id="tipologia" class="collapse">
                                <tr ng-repeat="permiso in list_permisos">
                                    ...
                                    <td ng-if="permiso.grupo == 'tipologia'" class="ancho_listado_checkbox"><input type="checkbox" ng-click="agregar_permiso(permiso, $index)" ng-model="check(permiso)" class="size_checkBox"></td> 
                                </tr>
                            </tbody>
                        </table>
                        <table class="table">
                            ...
                            <tbody id="tipo_asentamiento" class="collapse">
                                <tr ng-repeat="permiso in list_permisos">
                                    ...
                                    <td ng-if="permiso.grupo == 'tipo_asentamiento'" class="ancho_listado_checkbox"><input type="checkbox" ng-click="agregar_permiso(permiso, $index)" ng-model="check(permiso)" class="size_checkBox"></td> 
                                </tr>
                            </tbody>
                        </table>  
                        ...
                        <table class="table">
                            ...
                            <tbody id="documentos" class="collapse">
                                <tr ng-repeat="permiso in list_permisos">
                                    ...
                                    <td ng-if="permiso.grupo == 'documentos'" class="ancho_listado_checkbox"><input type="checkbox" ng-click="agregar_permiso(permiso, $index)" ng-model="check(permiso)" class="size_checkBox"></td> 
                                </tr>
                            </tbody>
                        </table>  
                        ...
                        <table class="table">
                            ...
                            <tbody id="series_documentos" class="collapse">
                                <tr ng-repeat="permiso in list_permisos">
                                    ...
                                    <td ng-if="permiso.grupo == 'series_documentos'" class="ancho_listado_checkbox"><input type="checkbox" ng-click="agregar_permiso(permiso, $index)" ng-model="check(permiso)" class="size_checkBox"></td> 
                                </tr>
                            </tbody>
                        </table>  
                        ...
                        <table class="table">
                            ...
                            <tbody id="serie" class="collapse">
                                <tr ng-repeat="permiso in list_permisos">
                                    ...
                                    <td ng-if="permiso.grupo == 'serie'" class="ancho_listado_checkbox"><input type="checkbox" ng-click="agregar_permiso(permiso, $index)" ng-model="check(permiso)" class="size_checkBox"></td> 
                                </tr>
                            </tbody>
                        </table>  
                        ...
                        <table class="table">
                            ...
                            <tbody id="tramite_concentracion" class="collapse">
                                <tr ng-repeat="permiso in list_permisos">
                                    ...
                                    <td ng-if="permiso.grupo == 'tramite_concentracion'" class="ancho_listado_checkbox"><input type="checkbox" ng-click="agregar_permiso(permiso, $index)" ng-model="check(permiso)" class="size_checkBox"></td> 
                                </tr>
                            </tbody>
                        </table>  
                        ...
                        <table class="table">
                            ...
                            <tbody id="investigador" class="collapse">
                                <tr ng-repeat="permiso in list_permisos">
                                    ...
                                    <td ng-if="permiso.grupo == 'investigador'" class="ancho_listado_checkbox"><input type="checkbox" ng-click="agregar_permiso(permiso, $index)" ng-model="check(permiso)" class="size_checkBox"></td> 
                                </tr>
                            </tbody>
                        </table>  
                        ...
                        <table class="table">
                            ...
                            <tbody id="solicitante" class="collapse">
                                <tr ng-repeat="permiso in list_permisos">
                                    ...
                                    <td ng-if="permiso.grupo == 'solicitante'" class="ancho_listado_checkbox"><input type="checkbox" ng-click="agregar_permiso(permiso, $index)" ng-model="check(permiso)" class="size_checkBox"></td> 
                                </tr>
                            </tbody>
                        </table>  
                        ...
                        <table class="table">
                            ...
                            <tbody id="servicio_expediente" class="collapse">
                                <tr ng-repeat="permiso in list_permisos">
                                    ...
                                    <td ng-if="permiso.grupo == 'servicio_expediente'" class="ancho_listado_checkbox"><input type="checkbox" ng-click="agregar_permiso(permiso, $index)" ng-model="check(permiso)" class="size_checkBox"></td> 
                                </tr>
                            </tbody>
                        </table>  
                        ...
                        <table class="table">
                            ...
                            <tbody id="servicio_devolucion" class="collapse">
                                <tr ng-repeat="permiso in list_permisos">
                                    ...
                                    <td ng-if="permiso.grupo == 'servicio_devolucion'" class="ancho_listado_checkbox"><input type="checkbox" ng-click="agregar_permiso(permiso, $index)" ng-model="check(permiso)" class="size_checkBox"></td> 
                                </tr>
                            </tbody>
                        </table>  
                    </div>
        ...
        <div class="col-sm-offset-10">
            <div class="form-group">
                <button type="submit" class="btn btn-primary" title="Guardar" ng-click="guardar(frmEditarPerfil)"><span class="glyphicon glyphicon-floppy-disk"></span> Guardar</button>
                <span>
