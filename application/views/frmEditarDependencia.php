...
<div class="panel panel-default col-lg-10 col-lg-offset-1" ng-controller="dependenciaEditCtrl">
    ...
    <form class="form-horizontal" name="formDependencia" novalidate style="margin-top: 11px;">
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control col-lg-1" id="dependencia_padre_id" name="dependencia_padre_id" ng-model="padre.nombre" />
            </div>
        </div>
        <div class="row col-sm-offset-1">
            <div class="form-group col-sm-4 has-feedback" ng-class="cssInput(formDependencia.clave)">
            ...
            <div class="form-group col-sm-4  has-feedback" ng-class="cssInput(formDependencia.codigo)">
                <label for="codigo" class="col-sm-3 control-label">Código:</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control col-sm-1" ng-maxlength="20" id="codigo" ng-disabled="true" name="codigo" ng-model="dependencia.codigo"/>
        ...
        <div class="form-group has-feedback" ng-class="cssInput(formDependencia.nombre)">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control col-lg-1" id="nombre" name="nombre" ng-maxlength="100" ng-minlength="5" ng-pattern="/^[a-zA-Z0-9\s\. ñáéíóú ÑÁÉÍÓÚ]*$/" ng-model="dependencia.nombre" required/>
        ...
        <div class="form-group has-feedback" ng-class="cssInput(formDependencia.resposable)">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control col-lg-1" id="resposable" name="resposable" ng-maxlength="100" ng-minlength="3" ng-pattern="/^[a-zA-Z\s\. ñáéíóú ÑÁÉÍÓÚ]*$/" ng-model="dependencia.responsable" required/>
        ...
        <div class="row col-sm-offset-1 has-feedback">
            <div class="form-group col-sm-4" ng-class="cssInput(formDependencia.titulo)">
            ...
            <div class="form-group col-sm-4 has-feedback" ng-class="cssInput(formDependencia.telefono)">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control col-lg-1" ng-maxlength="7" ng-minlength="7" id="telefono" ng-pattern="/^[0-9]{1,7}$/" name="telefono" ng-model="dependencia.telefono" required/>
