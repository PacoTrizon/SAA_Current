...
<div class="panel panel-default col-lg-10 col-lg-offset-1" ng-controller="sindicaturasCtrl">
    <div class="panel-heading"><h4>Sindicaturas</h4></div>
    <div class="row" style="margin-top: 11px;">
        <form method="GET" style="margin-top: 13px;" action="<?php echo base_url('sindicaturas/index'); ?>">           
        ...
        <a href="<?php echo base_url('sindicaturas/agregar'); ?>"><button type="button" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Nuevo</button></a>
    </div>
            ...
            <tbody>
                ...
                if ($resultado != 0) {
                    foreach ($resultado as $key => $results) {
                        ...
                        echo '<td>' . $results->nombre_municipio . '</td>';
                        if (intval($results->estatus) == 1)
                            echo '<td>ACTIVO</td>';
                        else
                            echo '<td>INACTIVO</td>';
                        echo '<td><a href="' . base_url('sindicaturas/editar/?id=' . $results->id_sindicatura) . '"><button type="button" title="Editar" class="btn btn-primary glyphicon glyphicon-pencil"></button></a></td>';
                        echo '</tr>';
                    }
                }
                ?>
