...
<div class="panel panel-default col-lg-10 col-lg-offset-1" ng-controller="paisesCtrl">
    <div class="panel-heading"><h4>Países</h4></div>
    <div class="row" style="margin-top: 11px;">
        <form method="GET" style="margin-top: 13px;" action="<?php echo base_url('paises/index'); ?>">
        ...
        <a href="<?php echo base_url('Paises/agregar'); ?>"><button type="button" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Nuevo</button></a>
    </div>
    <div class="panel-body">
        <table class="table table-striped">
            ...
            <tbody>
                <?php
                if ($resultsPaises != 0) {
                    foreach ($resultsPaises as $key => $results) {
                        echo '<tr>';
                        ...
                        if (intval($results->estatus) == 1)
                            ...
                            echo '<td>INACTIVO</td>';
                        echo '<td><a href="' . base_url('Paises/editar/?id=' . $results->id_pais) . '"><button type="button" title="Editar" class="btn btn-primary glyphicon glyphicon-pencil"></button></a></td>';
                        echo '</tr>';
                    }
                }
                ?>
